          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className="flex items-center gap-2 flex-1">
              ...
              <input
                ...
                className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1 text-zinc-200 "
              />
            </div>
            <div className="flex items-center gap-2 ">
              ...
              <input
                ...
                type="text"
                placeholder="Quando?"
                className="bg-transparent text-lg  placeholder-zinc-400 w-40 outline-none text-zinc-200 "
              />
            </div>
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            >
              ...
              <input
                ...
                className="  text-zinc-200 bg-transparent text-lg  placeholder-zinc-400 outline-none flex-1 "
              />
              <button
                type="submit"
                className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400"
